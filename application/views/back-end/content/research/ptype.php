                                    ...
                                    <div class="masonry-gallery">
                                        <div class="masonry-thumb" style="margin-left: 40%;">
                                            ...
                                            <img id="placeholder" class="grayscale"
                                                src="<?php echo base_url() ?>get_thumbs.php?im=<?php echo $path; ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="pop">
                                                <img src="<?php echo base_url() ?>get_thumbs.php?im=<?php echo $area->image_name; ?>"
                                                    style="width:50px;">
                                            </a>
                                        </td>
...
<script src="<?= base_url(); ?>v6/js/admin/research/ptype.js" type="text/javascript"></script>