    ...
    <section class="wrapper main-wrapper">
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title"> Publication Type </h1>
                </div>
        ...
        <div class="col-lg-6"><?php $this->load->view('back-end/common/message'); ?>
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left"> Add Publication Type </h2>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo $action; ?>">
                                ...
                                <fieldset>
                                    <div class="masonry-gallery">
                                        <div class="masonry-thumb" style="margin-left: 40%;">
                                            ...
                                            <img id="placeholder" class="grayscale" src="<?php echo base_url() ?>get_thumbs.php?im=<?php echo $path; ?>" width="142" alt="Sample Image">
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="form-group">
                                    ...
                                    <span style="font-size: 9px;font-style: italic;color: red;">(Please Using Dimensions 220 X 300 PX*)</span>
                                    <div class="controls">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc">e.g. "Annual Reports"</span>
                                    <div class="controls">
                                        <i class=""></i>
                                    ...
                                    foreach ($areaList->result() as $id => $area) : $x++; ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" class="pop">
                                                    <img src="<?php echo base_url() ?>get_thumbs.php?im=<?php echo $area->image_name; ?>" style="width:50px;">
                                                </a>
                                            </td>
                                            ...
                                            <td class="hidden-print">
                                                <?php
                                                $edit_action = $this->privilage->edit('edit', $session_user['user_id'], 'research/edittype/', $area->category_id);
...
<script>
    ...
    $('.pub-callback').click(function() {
        ...
        publishPublicType(delete_id, status, delete_tr);
    });

    function publishPublicType(delete_id, status, delete_tr) {
