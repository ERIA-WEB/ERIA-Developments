                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea rows="5" style="height: 250px" id="article_keywords"
                                            class="form-control mytextarea"
                                            name="article_keywords"><?php echo $article_keywords ?></textarea>
...
<script src="<?= base_url(); ?>v6/js/admin/experts/research.js" type="text/javascript"></script>