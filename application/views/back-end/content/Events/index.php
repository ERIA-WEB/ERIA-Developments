    ...
    <section class="wrapper main-wrapper">
        ...
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                ...
                <div class="pull-left">
                    <h1 class="title"> Manage Press Room Page </h1>
                </div>
                ...
                <div class="pull-right hidden-xs">
                    <ol class="breadcrumb">
                        <li>
                            <a href=" "><i class="fa fa-globe"></i><strong>Press Room </strong></a>
                        </li>
        ...
        <div class="col-lg-12"><?php $this->load->view('back-end/common/message'); ?>
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left"> Press Room </h2>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc">e.g. "Innovation Policy in/for ASEAN' Study 2nd Workshop"</span>
                                    <div class="controls">
                                        <i class=""></i>
...
<script src="<?= base_url(); ?>v6/js/admin/events/index.js" type="text/javascript"></script>