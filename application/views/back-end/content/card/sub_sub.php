                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label class="form-label" for="formfield3"> Sub Headinng </label>
                                    <div class="controls">
                                        <input type="text" value="<?= $contentData->headinng ?>" class="form-control" id="headinng" name="headinng">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label class="form-label" for="formfield3"> Button Text </label>
                                    <div class="controls">
                                        <input type="text" value="<?= $sub_heading ?>" class="form-control" id="sub_heading" name="sub_heading">
                                        <?php echo form_error('sub_heading', '<span class="help-inline">', '</span>'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <?php
                                    $error = (form_error('button') === '') ? '' : 'error';
                                    $button = (set_value('button') == false && isset($contentData)) ? $contentData->content : set_value('button');
                                    ?>
                                    <label class="form-label" for="formfield1"> Button Text Link </label>
                                    <span class="desc">e.g. " Subscribe "</span>
                                    <div class="controls">
                                        <input type="text" value="<?= $button ?>" class="form-control" id="button" name="button">
