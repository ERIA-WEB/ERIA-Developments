<section id="main-content">
    <section class="wrapper main-wrapper">
        ...
        <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo base_url(); ?>/system-content/card/insert_card">
            <div class="col-lg-12">
                <!-- start: Alert Message -->
                <style>
                    .help-inline {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required="required" value="" class="form-control" id="title" name="title" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div id="templateCardFile" class="form-group hidden">
                                    ...
                                    <div class="controls">
                                        <input class="input-file form-control uniform_on focused" id="file_card" value="" name="file_card" type="file" accept=".php/*" placeholder="Upload file card ext .php">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="formfield1"> Published </label>
                                    <div style="width: 30px" class="controls">
                                        <input type="checkbox" value="1" class="form-control" id="published" name="published">
                                    </div>
                                </div>
                ...
                <section id="templateCardCode" class="box hidden">
                    ...
                    <div class="content-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <textarea rows="5" id="summernoteTextArea" class="form-control mytextarea" name="template_content"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
