<section id="main-content">
    <section class="wrapper main-wrapper">
        ...
        <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
            action="<?php echo base_url(); ?>/system-content/card/insert_card">
            <div class="col-lg-12">
                <!-- start: Alert Message -->
                <style>
                .help-inline {
                                ...
                                <div id="templateCardFile" class="form-group hidden">
                                    ...
                                    <div class="controls">
                                        <input class="input-file form-control uniform_on focused" id="file_card"
                                            value="" name="file_card" type="file" accept=".php/*"
...
<script src="<?= base_url(); ?>v6/js/admin/cards/create_card.js" type="text/javascript"></script>