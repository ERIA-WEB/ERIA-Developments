                                    ...
                                    <div class="controls">
                                        ...
                                        <select class="" id="s2example-2" name="headinng" required="required">
                                            ...
                                            ?>
                                                ...
                                                <option <?php if ($headinng == $areaLists->article_id) { ?> selected="" <?php  } ?> value="<?php echo $areaLists->article_id; ?>"> <?php echo $this->privilage->RemoveBS($areaLists->title); ?></option>
                                    ...
                                    <div class="controls">
                                        ...
                                        <select class="" id="s2example-3" name="topics[]" required="required" multiple>
                                            ...
                                            ?>
                                                ...
                                                <option <?php if (in_array($areaList->article_id, $sub_heading)) { ?> selected="" <?php  } ?> value="<?= $areaList->article_id ?>"> <?php echo $areaList->title; ?></option>
