                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <?php
                                    ...
                                    //                         <option value="'.$video_id.'" '.$video_selected.'>
                                    //                             '.$video_name.'
                                    //                         </option>
                                    //                     </select>
                                    //                 </div>
                                    //             </div>';
                                    //     } elseif ($value->sub_experts === '8') {
                                    //         if (in_array($value->article_id, $sub_heading)) {
                                    //             $selected = 'selected';
                                    ...
                                    //         echo '<div class="form-group">
                                    //                 <label class="form-label" for="formfield4"> Select Podcasts </label>
                                    //                 <div class="controls">
                                    //                     <select class="form-control" name="topics[1]">
                                    //                         <option value="'.$podcasts_id.'" '.$podcasts_selected.'>
                                    //                             '.$podcasts_name.'
                                    //                         </option>
                                    //                     </select>
                                    //                 </div>
                                    //             </div>';
                                    //     } elseif ($value->sub_experts === '7') {
                                    //         if (in_array($value->article_id, $sub_heading)) {
                                    ...
                                    //         echo '<div class="form-group">
                                    //                 <label class="form-label" for="formfield5"> Select Webinar </label>
                                    //                 <div class="controls">
                                    //                     <select class="form-control" name="topics[2]">
                                    //                         <option value="'.$webinar_id.'" '.$webinar_selected.'>
                                    //                             '.$webinar_name.'
                                    //                         </option>
                                    //                     </select>
                                    //                 </div>
