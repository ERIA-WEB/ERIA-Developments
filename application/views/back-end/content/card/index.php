        ...
        <div class="col-lg-12">
            <section class="box">
                <header class="panel_header">
                    <h2 class="title pull-left"> Card List</h2>
                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-md-12 text-left" style="margin-bottom: 20px;">
                            <a class="btn btn-info" href="<?php echo base_url() ?>system-content/card/create_card">
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-print">
                                                ...
                                                if ($area->c_id > 1 && $area->c_id < 11) {
                                                    $edit_action = $this->privilage->edit('edit', $session_user['user_id'], 'card/edit_sub/', $area->c_id);
                                                } else {
                                                    $edit_action = $this->privilage->edit('edit', $session_user['user_id'], 'card/edit_card/', $area->c_id);
                                                }
    ...
    function confirmationCallbackDelete(delete_id, name, delete_tr) {
        $('.confirmation-callback').confirmation({
            ...
            onConfirm: function(event, element) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>system-content/card/deleteRese",
                    data: {
                        id: delete_id,
                        name: name
                    }
    ...
    function publishR(delete_id, status, delete_tr) {
        $('.pub-callback').confirmation({
            ...
            onConfirm: function(event, element) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>system-content/Card/publishR",
                    data: {
                        id: delete_id,
                        pub: status
                    }
