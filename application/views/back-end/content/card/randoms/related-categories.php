                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label class="form-label" for="formfield3"> Choose Content Categories / Publication
                                        Type </label>
                                    <div class="controls">
                                        <?php
                                            $article_topics = $this->Card_model->getCategoryResearchAreasCardByCategoryType('pubtypes');
