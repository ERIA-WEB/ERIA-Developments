                    ...
                    <div class="content-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="hidden" id="id" name="id" value="<?php echo (isset($contentData)) ? $contentData->pc_id : '' ?>" />
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div id="loading" class="text-center">
                                            <img src="<?php echo base_url() ?>upload/loading-bar-1.gif" class="w-100 hidden">
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control assig_order">
                                                            <option <?php if ($card['nm'] == 0) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="0">Deactive</option>
                                                            <option <?php if ($card['nm'] == 1) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="1">1</option>
                                                            <option <?php if ($card['nm'] == 2) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="2">2</option>
                                                            <option <?php if ($card['nm'] == 3) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="3">3</option>
                                                            <option <?php if ($card['nm'] == 4) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="4">4</option>
                                                            <option <?php if ($card['nm'] == 5) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="5">5</option>
                                                            <option <?php if ($card['nm'] == 6) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="6">6</option>
                                                            <option <?php if ($card['nm'] == 7) { ?> selected <?php } ?> data-page="<?= $card['c_id'] ?>" value="7">7</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                            <?php } ?>
...
<script>
    $('.assig_order').change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>system-content/Card/assignCart",
            data: {
                id: id,
                num: num,
                page: page
