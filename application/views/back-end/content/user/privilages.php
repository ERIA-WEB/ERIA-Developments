                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            ?>
                            <table style="font-size:12px;" id="" class=" dataTable display table table-hover table-condensed" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Module</th>
                                ...
                                <tbody>
                                    ...
                                    ?> <tr>
                                            ...
                                            <td colspan="3" class="thehead" style="border-left:#000 solid 1px; "><?php echo $privilages['main']; ?></td>
                                        ...
                                        foreach ($privilages['subdata'] as $sdata) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    ...
                                                    <input tabindex="5" id="<?php echo $sdata['id'] ?>" type="checkbox" class="form-control icheck-minimal-pink" <?php if ($sdata['cnt'] == 1) { ?> checked="checked" <?php } ?> onclick="_privilages(<?php echo $sdata['id'] ?>,<?php echo $sdata['ud'] ?>);  ">
                                            ...
                                            <tr id="collapse<?php echo $sdata['id'] ?>" class="panel-collapse collapse <?php if ($sdata['cnt'] == 1) { ?> in <?php  } ?> " role="tabpanel" aria-labelledby="headingOne" aria-expanded="false">
...
<script>
    function col(col) {
        if ($('#' + col).prop("checked") == true) {
            $('#collapse' + col).addClass('in');
        } else {
            $('#collapse' + col).removeClass('in');
        }
    }



    function cls(pri, id, mpid) {
