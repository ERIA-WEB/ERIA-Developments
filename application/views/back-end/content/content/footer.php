                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea rows="5" style="height: 250px" id="footer_about" class="form-control mytextarea" name="footer_about"><?= $footer_about ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea rows="5" style="height: 250px" id="summernote" class="form-control mytextarea" name="footer_Content"><?= $footer_Content ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?= $footer_copyrights ?>" id="footer_copyrights" class="form-control" name="footer_copyrights">
