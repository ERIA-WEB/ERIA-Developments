                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo $action; ?>">
                                ...
                                <input type="hidden" name="id" value="<?php echo (isset($banner_row)) ? $banner_row->banner_id : '' ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <i class=""></i>
                                        <input type="text" required="required" value="<?php echo $caption ?>" class="form-control" id="caption" name="caption">
                ...
                <div class="content-body" style="background:#f5f5f5">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12" id="dvContents">
                            <table id="example" style="font-size:12px;" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th> Title </th>
                                ...
                                <tbody>\
                                    ...
                                    foreach ($areaList->result() as $id => $area) : $x++; ?>
                                        <tr>
                                            ...
                                            <td> <a href="#" class="pop"> <img src="<?php echo base_url() ?>resources/images<?php echo $area->image_name; ?>" width="90"> </a> </td>
                                            <td> <?php echo $area->order_id; ?></td>
                                            <td class="hidden-print">

                                                <a class="btn btn-info" href="<?php echo base_url() ?>system-content/Content/editBanner/<?php echo $area->banner_id ?>">
                                                    <i class="fa fa-edit"></i> </a>
                                                &nbsp; &nbsp;
                                                <a href="#confirm" data-id="<?php echo $area->banner_id; ?>" data-area="<?php echo $area->caption; ?>" data-placement="left" class="btn btn-danger confirmation-callback">
