                ...
                <div class="content-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <i class=""></i>
                                <input type="text" required="required" value="<?php echo $title ?>" class="form-control"
                                    id="title" name="title">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <i class=""></i>
                                <input type="text" required="required" value="<?php echo $major ?>" class="form-control"
                                    id="major" name="major">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <i class=""></i>
                                <input type="email" value="<?php echo $majorEmail ?>" class="form-control"
                                    id="majorEmail" name="majorEmail">
                        ...
                        <div class="form-group">
                            ...
                            <div style="width: 30px" class="controls">
                                <i class=""></i>
                                <input type="checkbox" value="1" <?php if ($published == 1) { ?> checked <?php } ?>
...
<script src="<?= base_url(); ?>v6/js/admin/abouts/staff.js" type="text/javascript"></script>