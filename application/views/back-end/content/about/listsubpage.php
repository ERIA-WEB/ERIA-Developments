                            ...
                            <table id="examples" style="font-size:12px;"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <a data-toggle="modal" data-aid="<?php //$area->page_id ?>" class="btn btn-info _pdf " href="#myModal1">
                                        ...
                                        <td class="hidden-print">
                                            <?php
                                                $edit_action = $this->privilage->edit('edit', $session_user['user_id'], 'About/edit_subpage/', $area->page_id);
...
<script src="<?= base_url(); ?>v6/js/admin/abouts/listsubpage.js" type="text/javascript"></script>