                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-print">
                                            <?php
                                                $edit_action = $this->privilage->edit('edit', $session_user['user_id'], 'about/edit_pages_sub/', $value->id);
...
<script src="<?= base_url(); ?>v6/js/admin/abouts/all-sub/page.js" type="text/javascript"></script>