    ...
    <section class="wrapper main-wrapper">
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title"><?= !empty($slider_row) ? ucwords($slider_row->menu_title) : "ADD"; ?> Sub Page
                    </h1>
                </div>
                <div class="pull-right hidden-xs">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <?= !empty($slider_row) ? ucwords($slider_row->menu_title) : "ADD"; ?> Sub Page
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
                                ...
                                ?>
                                <?php 
                                    if (isset($_GET['parent_id']) && isset($_GET['page_id'])) {
                                        $parent_id = $_GET['parent_id'];
                                        $page_id = $_GET['page_id'];
                                    } else {
                                        $parent_id = (isset($slider_row)) ? $slider_row->parent_id : '';
                                        $page_id = (isset($slider_row)) ? $slider_row->page_id : '';
                                    }
                                ?>
                                ...
                                <div class="pull-right">
                                    ...
                                    <?php 
                                        if (isset($slider_row)) {
                                            $param_id = $slider_row->page_id;
                                        } else {
                                            $param_id = $_GET['page_id'];
                                        }
                                    ?>
                                    <a href="<?= base_url().'system-content/about/edit_page/'.$param_id ?>"
            ...
            ?>
            <?php if (end($urlArray) != 'subpage') {?>
            <section class="box">
                <header class="panel_header">
                    <h2 class="title pull-left"> List Sub Child Page
                        <?= !empty($slider_row) ? '"'.ucwords($slider_row->menu_title).'"' : ""; ?></h2>
                    <div class="actions panel_actions pull-right">
                        <a class="btn btn-success <?php if ($sub == 'subpage') { ?> active <?php } ?>"
                            href="<?php echo base_url() ?>system-content/about/add_sub_child_page?parent_id=<?= !empty($slider_row) ? $slider_row->parent_id :''; ?>&page_id=<?= !empty($slider_row) ? $slider_row->page_id :''; ?>&page_sub_id=<?= !empty($slider_row) ? $slider_row->id :''; ?>">
                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table id="examplesPageTables" style="font-size:12px;"
                                ...
                                <tbody>
                                    <?php  foreach ($page_sub_child as $key => $value) { ?>
                                    <tr>
                                        <td><?php echo ++$key; ?> </td>
...
<script src="<?= base_url(); ?>v6/js/admin/abouts/all-sub/subpage.js" type="text/javascript"></script>