                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc">e.g. "ERIA is an international organization established in Jakarta, Indonesia in 2008 by a formal agreement among Leaders of 16 countries"</span>
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control mytextarea" id="content" name="content"><?php echo $titles ?></textarea>
                                            <?php echo form_error('title', '<span class="help-inline">', '</span>'); ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control mytextarea" id="discription" name="discription"><?php echo $discription ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $buttonn ?>" class="form-control" id="buttonn" name="buttonn">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc">e.g. "https://www.eria.org/publications/how-do-sectoral-employment-structures-affect-mobility-during-the-covid-19-pandemic/"</span>
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $lik ?>" class="form-control" id="lik" name="lik">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $he1 ?>" class="form-control" id="he1" name="he1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="he1_dis" name="he1_dis"><?php echo $he1_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $he1_butt ?>" class="form-control" id="he1_butt" name="he1_butt">
                                    ...
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <label class="form-label" for="formfield1"> Button Link </label>
                                        <span class="desc">e.g. "https://www.eria.org/publications/ageing-and-health-vietnam"</span>
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $he1_link ?>" class="form-control" id="he1_link" name="he1_link">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $he2 ?>" class="form-control" id="he2" name="he2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" value="" class="form-control" id="he2_dis" name="he2_dis"><?php echo $he2_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $he2_butt ?>" class="form-control" id="he2_butt" name="he2_butt">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $he2_link ?>" class="form-control" id="he2_link" name="he2_link">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $he3 ?>" class="form-control" id="he3" name="he3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" value="" class="form-control" id="he3_dis" name="he3_dis"><?php echo $he3_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $he3_butt ?>" class="form-control" id="he3_butt" name="he3_butt">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $he3_link ?>" class="form-control" id="he3_link" name="he3_link">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $hig_menu1 ?>" class="form-control" id="hig_menu1" name="hig_menu1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $hig_menu_h1 ?>" class="form-control" id="hig_menu_h1" name="hig_menu_h1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $hig_menu_b1 ?>" class="form-control" id="hig_menu_b1" name="hig_menu_b1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $hig_menu_b1_link ?>" class="form-control" id="hig_menu_b1_link" name="hig_menu_b1_link">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $hig_menu2 ?>" class="form-control" id="hig_menu2" name="hig_menu2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $hig_menu_h2 ?>" class="form-control" id="hig_menu_h2" name="hig_menu_h2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $hig_menu_b2 ?>" class="form-control" id="hig_menu_b2" name="hig_menu_b2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $hig_menu_b2_link ?>" class="form-control" id="hig_menu_b2_link" name="hig_menu_b2_link">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-3 col-xs-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $r_head ?>" class="form-control" id="r_head" name="r_head">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <label class="form-label" for="formfield1"> Description </label>
                                        <span class="desc">e.g. "ERIA's research on agricultural development attempts to address the growing opportunities for agricultural development and trade arising from a robustly growing East Asia, as well as the political and social imperative of food security in the region."</span>
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="rdis" name="rdis"><?= $rdis ?></textarea>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $rbbutton ?>" class="form-control" id="rbbutton" name="rbbutton">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <label class="form-label" for="formfield1"> Button Link </label>
                                        <span class="desc">e.g. "https://www.eria.org/research/topic/agricultural-development"</span>
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $r_link ?>" class="form-control" id="r_link" name="r_link">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $h_1 ?>" class="form-control" id="h_1" name="h_1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="he1_dis" name="h_1_dis"><?php echo $h_1_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_1_b ?>" class="form-control" id="h_1_b" name="h_1_b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_1_l ?>" class="form-control" id="h_1_l" name="h_1_l">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $h_2 ?>" class="form-control" id="h_2" name="h_2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="h_2_dis" name="h_2_dis"><?php echo $h_2_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_2_b ?>" class="form-control" id="h_2_b" name="h_2_b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_2_l ?>" class="form-control" id="h_2_l" name="h_2_l">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $h_3 ?>" class="form-control" id="h_3" name="h_3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="h_3_dis" name="h_3_dis"><?php echo $h_3_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_3_b ?>" class="form-control" id="h_3_b" name="h_3_b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_3_l ?>" class="form-control" id="h_3_l" name="h_3_l">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $h_4 ?>" class="form-control" id="h_4" name="h_4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="h_4_dis" name="h_4_dis"><?php echo $h_4_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_4_b ?>" class="form-control" id="h_4_b" name="h_4_b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_4_l ?>" class="form-control" id="h_4_l" name="h_4_l">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $h_5 ?>" class="form-control" id="h_5" name="h_5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="h_5_dis" name="h_5_dis"><?php echo $h_5_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_5_b ?>" class="form-control" id="h_5_b" name="h_5_b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_5_l ?>" class="form-control" id="h_5_l" name="h_5_l">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?= $h_6 ?>" class="form-control" id="h_6" name="h_6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <textarea required="required" class="form-control" id="h_6_dis" name="h_6_dis"><?php echo $h_6_dis ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_6_b ?>" class="form-control" id="h_6_b" name="h_6_b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <i class=""></i>
                                            <input type="text" required="required" value="<?php echo $h_6_l ?>" class="form-control" id="h_6_l" name="h_6_l">
