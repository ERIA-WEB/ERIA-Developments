    ...
    <section class="wrapper main-wrapper">
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title"> Manage Database and Programmes Page </h1>
                </div>
        ...
        <div class="col-lg-12"><?php $this->load->view('back-end/common/message'); ?>
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left"> Programmes </h2>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc">e.g. "Database & Programmes"</span>
                                    <div class="controls">
                                ...
                                <div class="form-group">
                                    ...
                                    $title = (set_value('title') == false && isset($slider_row)) ? $slider_row->menu_title : set_value('title');
                                    ?>
...
<script src="<?= base_url(); ?>v6/js/admin/programmes/index.js" type="text/javascript"></script>