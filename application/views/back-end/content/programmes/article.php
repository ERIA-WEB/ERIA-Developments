        ...
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    ...
                    if (in_array('editArt', $urlArray)) {
                        $title_h1 = 'Edit Article';
                    } else {
                        $title_h1 = 'Add Article';
                    }
                    ?>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" required="required"
                                            value="<?php echo $this->privilage->RemoveBS($menu_title); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select class="" id="categoryProgrammes" name="catogery[]" multiple>
                                            <?php
                                            ...
                                            <option <?php if ($catogery->category_id ==  $topicId) { ?> selected=""
                                                <?php  } ?> value="<?= $catogery->category_id ?>">
                                                <?= $catogery->category_name ?></option>
                                            <?php } ?>
                                            <?php } ?>
                                        </select>
                                        <?php echo form_error('menu_title', '<span class="help-inline">', '</span>'); ?>
                                        <span class="err" style="color:red; padding: 5px; display: none "> Category
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select class="" id="subCategory" name="subcategory[]" multiple>
                                            ...
                                            <option <?php if ($value->category_id == $subTopicId) { ?> selected=""
                                                <?php  } ?> value="<?= $value->category_id ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc">e.g. "The Longitudinal Study of Ageing and Health in Viet Nam
                                        (LSAHV)"</span>
                                    <div class="controls">
                                        <textarea rows="5" style="height: 250px" id="short_des1"
                                            class="form-control mytextarea"
                                            name="short_des"><?= $short_des ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc">e.g. "The Longitudinal Study of Ageing and Health in Viet Nam
                                        (LSAHV) is the first multi-actor longitudinal study on ageing in Viet Nam with
                                        information collected from older Vietnamese people, their current and potential
                                        caregivers, and adult children. The 2018 baseline data provides
                                        comprehensive"</span>
                                    <div class="controls">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <i class=""></i>
                                        <input type="time" value="<?= $event_time ?>" id="event_time" name="event_time"
                                            class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select class="" id="relatedArticleProgrammes" name="related[]" multiple>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc">e.g. "
                                        Type in article title and press enter "<br>
                                        <span style="font-size: 9px;font-style: italic;color: red;">Publication must be
                                            2*</span>
                                    </span>
                                    <div class="controls">
                                        <select id="relatedPublicationInProgrammes" name="related_publication[]"
                                            multiple>
...
<script src="<?= base_url(); ?>v6/js/admin/programmes/article.js" type="text/javascript"></script>