                     ...
                     <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    <li>
                                        <a href=" "><i class="fa fa-globe"></i><strong>Configuration</strong></a>
                                    </li>
...
<div class="col-lg-6"><?php   $this->load->view('back-end/common/message'); ?>
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left"> Google </h2>
...
<?php
                ...
                <input type="hidden" name="id" value="<?php echo (isset($contentData)) ? $contentData->id : '' ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="form-label" for="formfield1"> google_map_api  </label>
                                                <span class="desc">e.g. "Adsdf"</span>
                                                <div class="controls">
                                                    <i class=""></i>
                                                    <input type="text"  value="<?=$google_map_api?>"  class="form-control" id="home_title" name="home_title" >
                    ...
                    ?>
                                ...
                                <label class="form-label" for="formfield1">  google_analytic_tag </label>
                                  <span class="desc">e.g. "100"</span>
                                <div class="controls">
                                <i class=""></i>
                             <input type="text" required="required" value="<?php echo $google_analytic_tag ?>" class="form-control" id="sort_order" name="sort_order" >
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc">e.g. "Home"</span>
                                                <div class="controls">
                                                    <i class=""></i>
                                                    <input type="text"  value="<?=$email?>"  class="form-control" id="page_title" name="page_title" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="form-label" for="formfield1">   map_lat_long </label>
                                                <span class="desc">e.g. "ERIA"</span>
                                                <div class="controls">
                                                    <i class=""></i>
                                                    <input type="text" required="required" value="<?php echo $map_lat_long ?>" class="form-control" id="sort_title" name="sort_title" >
