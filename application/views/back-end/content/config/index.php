                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?=$google_map_api?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required="required"
                                            value="<?php echo $google_analytic_tag ?>" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?=$email?>" class="form-control" id="page_title"
                                            name="page_title">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required="required" value="<?php echo $map_lat_long ?>"
