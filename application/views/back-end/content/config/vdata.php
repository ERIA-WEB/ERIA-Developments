                ...
                <section class="wrapper main-wrapper" style=''>
                     ...
                     <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title"> Variable Content Manage  </h1>                            </div>
                ...
                <input type="hidden" name="id" value="<?php echo (isset($contentData)) ? $contentData->id : '' ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls  ">
                                                    ...
                                                    <input type="url"  value="<?=$fb?>"  class="form-control" id="page_title" name="page_title" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls  ">
                                                ...
                                                <input type="url"  value="<?=$Twitter?>"  class="form-control" id="short_page_title" name="short_page_title" >
