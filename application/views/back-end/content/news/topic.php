    ...
    <section class="wrapper main-wrapper">
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title"> Manage and Add Topic </h1>
                </div>
        ...
        <div class="col-lg-6"><?php $this->load->view('back-end/common/message'); ?>
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left"> Add Topic </h2>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form id="login_form" method="POST" enctype="multipart/form-data" accept-charset="utf-8"
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label class="form-label" for="formfield1"> Topic </label>
                                    <span class="desc">e.g. "Academic Advisory Council"</span>
                                    <div class="controls">
                                        <i class=""></i>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-print">
                                            <?php
                                                $edit_action = $this->privilage->edit('edit', $session_user['user_id'], 'News/edittop/', $area->category_id);
...
<script src="<?= base_url(); ?>v6/js/admin/news/topic.js" type="text/javascript"></script>