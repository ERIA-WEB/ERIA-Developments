                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <span class="desc">e.g. "ERIA Holds Webinar on Agility and Resilience of Micro-Businesses Amidst and After the Pandemic."</span>
                                            <div class="controls">
                                                <i class=""></i>
                                                <input type="text" required="required" value='<?php echo  $this->privilage->RemoveBS($title); ?>' class="form-control" id="title" name="title">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <i class=""></i>
                                                <select class="" id="s2example-2" name="catogery">
                                                    <option>Choose Multimedia Categories</option>
                                                    <?php foreach ($areaList as $areaList) { ?>
                                                        <option <?php if ($sub_experts == $areaList->ec_id) { ?> selected="" <?php  } ?> value="<?php echo $areaList->ec_id; ?>"> <?php echo $areaList->category; ?></option>
                                                    <?php } ?>
                                                </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label class="form-label" for="formfield1"> Multimedia Sub Categories </label>
                                            <span class="desc">e.g. "Webinars"</span>
                                            <div class="controls">
                                                <select class="form-control" name="scat">
                                                    ...
                                                    <?php foreach ($sub_category_multimedia as $subcategory) { ?>
                                                        <option <?php if ($subcategorymultimedia == $subcategory->es_id) { ?> selected="" <?php  } ?> value="<?php echo $subcategory->es_id; ?>"> <?php echo $subcategory->s_catogery; ?></option>
                                                    <?php } ?>
                                                </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label id="LabelNameCategory" class="form-label" for="formfield1"> Video / Podcast / Webinar </label>
                                            <span style="font-size: 9px;font-style: italic;color: red;">( Please input IFRAME* )</span>
                                            <div class="controls">
                                                <i class=""></i>
                                                <textarea class="form-control mytextarea" id="video_url" name="video_url" style="height: 150px;"><?php echo $video_url; ?></textarea>
                                            ...
                                            <div class="controls">
                                                <select class="" id="s2example-3" name="topics[]" multiple>
                                                    <?php foreach ($area_List->result() as $areaList) { ?>
                                                        <option <?php if (in_array($areaList->category_id, $topData)) { ?> selected="" <?php  } ?> value="<?php echo $areaList->category_id; ?>"> <?php echo $areaList->category_name; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <?php echo form_error('menu_title', '<span class="help-inline">', '</span>'); ?>
                                            </div>
                                            ...
                                            <div class="controls">
                                                ...
                                                <select id="branch" name="editor" class="">
                                                    <?php foreach ($editor_d as $areaList) { ?>
                                                        <option <?php if ($editor == $areaList->title) { ?> selected="" <?php  } ?> value="<?= $areaList->title ?>"><?= $areaList->title ?></option>
                                                    <?php } ?>
                                                </select>
...
<script>
    ...
    function loadSub_cat(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>system-content/News/getSub",
            data: {
                id: id
