...
$(window).scroll(function() {
    var overview = $('#overviewBtn').data('overview');
    var expertise = $('#expertiseBtn').data('expertise');
    var education = $('#educationBtn').data('education');
    var experience = $('#experienceBtn').data('experience');
    var publications = $('#publicationsBtn').data('publications');
    var other_publications = $('#otherPublicationsBtn').data('otherpublications');
    var others = $('#othersBtn').data('others');
    var presentations = $('#presentationsBtn').data('presentations');
    ...
    if (overview != 'undefined') {
        ...
        if (scroll > 0 && scroll < 440) {
            // overview
            $('#overviewSticky').addClass('active-border');

            $('#educationSticky').removeClass('active-border');
            $('#experienceSticky').removeClass('active-border');
            $('#expertiseSticky').removeClass('active-border');
            $('#publicationsSticky').removeClass('active-border');
            $('#otherPublicationsSticky').removeClass('active-border');

            $('#othersSticky').removeClass('active-border');
            $('#presentationsSticky').removeClass('active-border');
            console.log("overview > " + scroll);
        }
    }

    if (expertise != 'undefined') {
        if (scroll > 441 && scroll < 728) {
            // expertise
            $('#expertiseSticky').addClass('active-border');

            $('#educationSticky').removeClass('active-border');
            $('#experienceSticky').removeClass('active-border');
            $('#overviewSticky').removeClass('active-border');
            $('#publicationsSticky').removeClass('active-border');
            $('#otherPublicationsSticky').removeClass('active-border');

            $('#othersSticky').removeClass('active-border');
            $('#presentationsSticky').removeClass('active-border');
            console.log("expertise > " + scroll);
        }
    }

    if (education != 'undefined') {
        if (scroll > 929 && scroll < 1068) {
            // education
            console.log("education > " + scroll);
            $('#educationSticky').addClass('active-border');
    ...
    if (experience != 'undefined') {
        if (scroll > 1069 && scroll < 1419) {
            // experience
            console.log("experience > " + scroll);
            $('#experienceSticky').addClass('active-border');
    ...
    if (publications != 'undefined') {
        if (scroll > 1252 && scroll < 2128) {
            // publication
            console.log("publications > " + scroll);
            $('#publicationsSticky').addClass('active-border');
    ...
    if (other_publications != 'undefined') {
        if (scroll > 2173 && scroll < 2426) {
            // publication
            console.log("other_publications > " + scroll);
            $('#otherPublicationsSticky').addClass('active-border');
    ...
    if (others != 'undefined') {
        if (scroll > 2144 && scroll < 2679) {
            // others
            console.log("others > " + scroll);
            $('#othersSticky').addClass('active-border');
    ...
    if (presentations != 'undefined') {
        if (scroll > 2679 && scroll < 3046) {
            // persentations
            console.log("presentations > " + scroll);

            $('#presentationsSticky').addClass('active-border');
...
$(document).ready(function() {
    ...
    $('#overviewSticky').on('click', function() {
        ...
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#overview").offset().top - 75,
        }, 1000);
    });

    $('#expertiseSticky').on('click', function() {
        ...
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#expertise").offset().top - 75
        }, 1000);
    });


    $('#educationSticky').on('click', function() {
    ...
    $('#experienceSticky').on('click', function() {
    ...
    $('#publicationsSticky').on('click', function() {
        ...
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#publications").offset().top - 75
        }, 1000);
    });

    $('#otherPublicationsSticky').on('click', function() {
        ...
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#other-publications").offset().top - 75
        }, 1000);
    });

    $('#othersSticky').on('click', function() {
        ...
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#others").offset().top - 75
        }, 1000);
    });

    $('#presentationsSticky').on('click', function() {
        ...
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#presentations").offset().top - 75
        }, 1000);
    });
});
</script>
...
$(document).ready(function() {
    ...
    var start = 0;
    var limit = 6;
    var title_experts = $('#title_expert').val();

    getPostExpertPublicationData(title_expert, start, limit);
    ...
    function getPostExpertPublicationData(title_expert, start, limit) {

        var url = '<?= base_url() ?>Experts/get_publication_expert';
        var myformData = new FormData();
        myformData.append('start', start);
        myformData.append('limit', limit);
        myformData.append('title', title_experts);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response == "") {
                    ...
                    start += limit;
                    $(".loader-image").show();
                    $("#experts-publications").append(response); // publications
                }
            }
        });
    }
