...
function limit_text_($text, $limit, $link = null)
{
...
<div class="publications-page section-top">
    <!-- highlights -->
    <div class="highlights py-5 mb-3">
        <div class="container">
            <div class="row mb-3">
                <div class="col-lg-6">
                                ...
                                <div class="highlight-swiper-slider-content text-white pl-md-5">
                                    ...
                                    <p class="description mt-3 pr-lg-5">
                                        <?php
                                            ...
                                            $ns = strip_tags($n);
                                            echo limit_text_($ns, 50, 'publications/' . $news['uri']);
                                            ?>
                                    </p>
...
<script src="<?= base_url(); ?>v6/js/publications/publications-main.js"></script>