    ...
    <div id="dvContents">
        ...
        <div class="container download-section-two top-cover pt-0 pl-0 pr-0">
            <div class="row">
                <div class="col-lg-8 col-12 page-content">
                    ...
                    <div class="gray-box p-4 mb-3">
                        ...
                        <div class="row row-cols-2">
                            <div class="col-md-7">
                                <div class="social-media-icons pt-0">
                            ...
                            <div class="col-md-5 d-flex flex-column text-right">
                ...
                <div class="col-md-4 content-section-right d-none d-lg-block pb-4">
                    <?php
                        if (!empty($card)) {
                            foreach ($card as $c) {
                                if (!empty($c->file)) {
