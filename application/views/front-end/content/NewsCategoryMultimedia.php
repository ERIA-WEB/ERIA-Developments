            ...
            <div id=" videos" class="mb-5">
                <div class="row mb-4">
                    <div class="col-lg-12 d-flex justify-content-between align-items-center">
                        <?php 
                            if ($title_category == 'Unclassified') {
                                $title_page = 'Search Results';
                            } else {
                                $title_page = ucwords($title_category).'s';
                            }
                        ?>
                        <h2 class="second-title text-blue"><?php echo $title_page; ?></h2>
                    </div>
                </div>
                <div class="row">
                    <?php foreach ($multimedia_data as $multimedia) { ?>
                    <?php
                        if (!empty($multimedia->category)) {
                            $titlecategory = $multimedia->category;
                        } else {
                    ...
                    <div class="col-md-4">
                        <a
                            href="<?php echo base_url() . 'multimedia/' . strtolower($titlecategory) . '/' . $multimedia->uri; ?>">
                            <div class="card multimedia-video-card rounded-0 border-0">
                                <div class="video-card-header mb-2">
                                    <img src="<?php echo base_url() . $multimedia->image_name; ?>"
                                        alt="<?php echo $multimedia->title; ?>">
                                </div>
                                <div class="video-card-body">
                                    <small
                                        class="category text-uppercase mb-2"><?php echo ucfirst($titlecategory); ?></small>
                                    <p class="font-weight-bold"><?php echo $multimedia->title; ?></p>
                                    <p class="date"><?php echo date('j F Y', strtotime($multimedia->posted_date)); ?>
                                    </p>
                                </div>
                            </div>
                        </a>
