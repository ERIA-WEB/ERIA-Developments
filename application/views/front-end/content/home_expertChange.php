...
<div class="container-fluid page-cover section-top">
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide cover-responsive" data-ride="carousel">
                <div class="carousel-inner cover-responsive">
                    ...
                    foreach ($sliders as $slider) {
                        ...
                        <div class="carousel-item <?php if ($x == 1) { ?>active <?php } ?>   cover-responsive mySlides">
                            ...
                            <div class="container col-md-12 col-lg-12 col-xs-12 h-100 cover-right">
                                ...
                                <div style="width: 500px; " class="container fades p-4 cover-right-spacing">
                                    ...
                                    <p class="text-light py-3">
                                        ...
                                        $n = preg_replace("/<h2(.*)<\/h2>/iUs", " ", $slider->content);
                                        $ns = strip_tags($n);
...
<nav class=" navbar navbar-expand-sm featured-topic-areas p-md-3 px-5 py-2">
                                    ...
                                    <div class="carousel-item <?php if ($e == 1) { ?> active <?php } ?> ">
                                        <div class="col-md-4 pl-0 pr-md-4 item-inner">
                                            <div class="card card-body border-0 px-0">
                                                <div style="height: 230px" class="person-main pl-5 pr-4 py-4">
                                                    <div class="image-container">
                                                        <img width="100" height="100" class="img-fluid img-round" src="<?= base_url() ?><?= $experts['image_name'] ?>">
                                                    </div>
                                                    <div class="name mt-2"><a href="<?php echo base_url() ?>Experts/detail/<?= $experts['uri'] ?>"><?php
                                                    ...
                                                    <div class="status"> <?php
                                                                            ...
                                                                            //echo substr(strip_tags($experts['major']),0,32);

                                                                            ?></div>
                                                </div>
                                                <div style="height: 120px; " class="person-description pl-5 pr-4 py-4">
                                                    <div class="department"><?= $experts['major'] ?></div>
                                                    <div class="description mt-2 pr-5"><?php


                                                                                        $ns = substr(strip_tags($experts['content']), 0, 40);


                                                                                        $str = substr($ns, 0, strrpos($ns, ' '));

                                                                                        if (strlen($experts['content']) > 40) {
                                                                                            echo $str . "...";
                                                                                        } else {
                                                                                            echo $str;
                                                                                        }
                                                ...
                                                <div class="new_pub col-md-8 col-xs-12 text-light">
                                                    ...
                                                    <div class="highlight-author pb-4 pt-1">
                                                        ...
                                                        ?>
                                                                ...
                                                                Writer(s)/Editor(s) : <?php foreach ($pub['editornew'] as $ed) {
    ...
    margin-top: 425px; ">
                                        ...
                                        ?>
                                            <span class="dot pdot <?php if ($d == 1) { ?> actives <?php } ?> " onclick="currentSlide(<?= $d ?>)"></span>
                                ...
                                <!-- Carousel controls -->
                                <a class="carousel-control-prev" href="#highlightsCarousel" onclick="plus_pubSlides(-1)" data-slide="prev">
                                    <!-- <span class="carousel-control-prev-icon"></span> -->
                                    <img src="<?php echo base_url() ?>v6/assets/Icons/ovel_arrow_left.png">
                                </a>
                                <a class="carousel-control-next" href="#highlightsCarousel" onclick="plus_pubSlides(1)" data-slide="next">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 px-md-0">
                                <div class="row pt-4 mx-0">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <iframe width="100%" height="400px" src="https://www.youtube.com/embed/<?= substr($multimedia[0]->video_url, 17, 100) ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        ...
                                        <button onclick="reload_('<?= base_url() ?>NewsMultimedia/detail/<?= $multimedia[0]->uri ?>')" class="btn mt-3 font-weight-bold"><a href="<?= base_url() ?>NewsMultimedia/detail/<?= $multimedia[0]->uri ?>">LEARN MORE</a><span class="fa fa-angle-right font-weight-bold"></span></button>
                                    </div>
                                    <div class="col-md-4 col-xs-12">
                                        <iframe width="100%" height="200px" src="https://www.youtube.com/embed/<?= substr($multimedia[1]->video_url, 17, 100) ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        <div class="heading mb-3"><a href="<?= base_url() ?>NewsMultimedia/detail/<?= $multimedia[1]->uri ?>">

                                                <?php


                                                $string = preg_replace("/<p\s(.+?)>(.+?)<\/p>/is", " $2 ", $multimedia[1]->content);
                                        ...
                                        <iframe width="100%" height="200px" src="https://www.youtube.com/embed/<?= substr($multimedia[2]->video_url, 17, 100) ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
