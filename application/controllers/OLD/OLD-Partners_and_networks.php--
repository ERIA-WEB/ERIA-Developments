...
class Partners_and_networks extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['contentData']    = $content;
        $data['m_menu']         = 'message';
        $data['organizations']  = $this->frontModel->get_article(null, 'organizations', null, 'organizations');
        $data['left']           = 'org';
        $data['content']        = 'front-end/content/organization';
