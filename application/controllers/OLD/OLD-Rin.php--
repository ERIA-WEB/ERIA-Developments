...
class Rin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['m_menu']         = 'message';
        $data['left']           = 'rin';
        $data['boardmessages']  = $this->frontModel->getPage_content(13);
        $data['content']        = 'front-end/content/rin';
    ...
    public function energy()
    {
        ...
        $data['m_menu'] = 'message';
        $data['left'] = 'energy';
        $data['boardmessages'] = $this->frontModel->getPage_content(21);
        $data['content'] = 'front-end/content/rin';
