...
if (in_array($_SERVER['REMOTE_ADDR'], $whitelist)) {
	$baseUrl = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST']."/myApp/WEBSITE-ERIA-ORG/www.eria.org/";
} else {
...
$read_access = $write_access = $delete_access = true;
...
$config = array(
	...
	*/
	...
	'access_keys' => array($_GET['akey']), // md5("15".$_SERVER['REMOTE_ADDR'].date('Ymd'))
	...
	*/
	...
	//******************
	'delete_files'                            => $delete_access,
	'create_folders'                          => $write_access,
	'delete_folders'                          => $delete_access,
	'upload_files'                            => $write_access,
	'rename_files'                            => $write_access,
	'rename_folders'                          => $write_access,
	'duplicate_files'                         => $write_access,
	'copy_cut_files'                          => $write_access, // for copy/cut files
	'copy_cut_dirs'                           => $write_access, // for copy/cut directories
	'chmod_files'                             => false, // change file permissions
	'chmod_dirs'                              => false, // change folder permissions
	'preview_text_files'                      => $read_access, // eg.: txt, log etc.
	'edit_text_files'                         => $write_access, // eg.: txt, log etc.
	'create_text_files'                       => $write_access, // only create files with exts. defined in $editable_text_file_exts
