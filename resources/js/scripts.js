...
jQuery(function ($) {
    ...
    ULTRA_SETTINGS.windowBasedLayout = function () {
        ...
        if ($("body").hasClass("chat-open") || $("body").hasClass("sidebar-collapse")) {
            ...
            if (url == "http://uthayan.biz/reports/sales") {
            ...
            else if (url == "http://uthayan.biz/reports/income") {
        ...
        $('.page-chatapi .user-row').on('click', function () {
            ...
            if ($(this).hasClass("active")) {
                ...
                if ($(".chatapi-windows #user-window" + id).length) {
                    ...
                    var msg = chatformat_msg('Future Development!', 'receive', name);
                    msg += chatformat_msg('Future Development ;)', 'sent', 'You');
    ...
    ULTRA_SETTINGS.otherScripts = function () {
            ...
            $(".datepicker").each(function (i, e) {
                var $this = $(e),
                    options = {
                        ...
                        format: getValue($this, 'format', 'YY-mm-dd'),
        ...
        if ($.isFunction($.fn.select2)) {
            ...
            $("#s2example-1").select2({
                placeholder: 'Select your Related...',
                allowClear: true
            ...
            $("#selectEventPeople").select2({
                placeholder: 'Choose events for people',
                allowClear: true
            }).on('select2-open', function () {
                // Adding Custom Scrollbar
                $(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
            ...
            $("#s2example-8").select2({
                placeholder: 'Choose your Members',
                allowClear: true
            }).on('select2-open', function () {
                // Adding Custom
                $(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
            ...
            $("#s2example-9").select2({
                ...
                // Adding custome select
                $(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
            });

            $("#main_cat").select2({
                placeholder: 'Choose your Main Cat',
                allowClear: true
            }).on('select2-open', function () {
                // Adding Custom Scrollbar
                $(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
